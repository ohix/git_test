...
zahlen = list(range(1,50)) #Liste für Zahlen von 1 bis 49
random.shuffle(zahlen) #Liste zufällig mischen
...
for i in range(1,7): # 1 bis 6 (7 nicht inklusive)
    ...
    while eingabe in nutzer_zahlen or eingabe > 49: #Falls Eingabe schon vorhanden oder größer als 49
